...
const MENU_COACH = [
  ...
  { g: "Programma", ic: "▦", subs: [
    ...
    ["template", "Template microcicli"], ["piano", "Piano e picco"], ["periodizzazione", "Periodizzazione"], ["per-distanza", "Per distanza (mezzo)"], ["guida-mezzi", "Guida mezzi (mezzo)"], ["guida-test", "Guida test mezzofondo"], ["guida-mezzi-lanci", "Guida mezzi (lanci)"], ["modello-tecnico", "Modello tecnico (lanci)"]] },
  { g: "Analisi", ic: "◭", subs: [
...
const DA_EXCEL = {
  ...
  pista: "Pista", palestra: "Palestra", riscaldamento: "Riscaldamento",
  template: "Template microcicli", piano: "Piano & Picco", periodizzazione: "Periodizzazione", "per-distanza": "Per distanza", "guida-mezzi": "Guida mezzi", "guida-test": "Guida test", "guida-mezzi-lanci": "Guida mezzi (lanci)", "modello-tecnico": "Modello tecnico",
